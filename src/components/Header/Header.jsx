    ...
    return (
        <nav className='md:px-5 md:p-5 p-2 bg-[#f9f8ff]'>
            <div className='container md:w-4/5 mx-auto flex gap-3 justify-between items-center'>
                ...
                <div className= {`text-lg absolute md:static font-semibold flex flex-col md:flex-row gap-5 md:gap-10 z-10 ${open ? 'top-16 bg-gradient-to-r from-[#7E90FE] to-[#9873FF] p-5 rounded-lg text-white' : '-top-60'}`}>
